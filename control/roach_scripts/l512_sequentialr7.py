...
fpga.write_int('tenge_ips_ip2',dest_ip0)
fpga.write_int('tenge_ips_ip3',dest_ip1)
fpga.write_int('tenge_ips_ip4',dest_ip1)
fpga.write_int('tenge_ips_ip5',dest_ip2)
fpga.write_int('tenge_ips_ip6',dest_ip2)
fpga.write_int('tenge_ips_ip7',dest_ip3)
fpga.write_int('tenge_ips_ip8',dest_ip3)
fpga.write_int('tenge_ips_ip9',dest_ip4)
fpga.write_int('tenge_ips_ip10',dest_ip4)
fpga.write_int('tenge_ips_ip11',dest_ip5)
fpga.write_int('tenge_ips_ip12',dest_ip5)
fpga.write_int('tenge_ips_ip13',dest_ip6)
fpga.write_int('tenge_ips_ip14',dest_ip6)
fpga.write_int('tenge_ips_ip15',dest_ip7)
fpga.write_int('tenge_ips_ip16',dest_ip7)
fpga.write_int('tenge_ips_ip17',dest_ip8)
fpga.write_int('tenge_ips_ip18',dest_ip8)
fpga.write_int('tenge_ips_ip19',dest_ip9)
fpga.write_int('tenge_ips_ip20',dest_ip9)
fpga.write_int('tenge_ips_ip21',dest_ip10)
