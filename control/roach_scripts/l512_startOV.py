...
fpga3.write_int('adc_rst', 3)

fpga4.write_int('tenge_enable', 0)
fpga4.write_int('adc_rst', 3)

fpga5.write_int('tenge_enable', 0)
fpga5.write_int('adc_rst', 3)

fpga6.write_int('tenge_enable', 0)
fpga6.write_int('adc_rst', 3)

fpga7.write_int('tenge_enable', 0)
fpga7.write_int('adc_rst', 3)

fpga8.write_int('tenge_enable', 0)
fpga8.write_int('adc_rst', 3)

fpga9.write_int('tenge_enable', 0)
fpga9.write_int('adc_rst', 3)

fpga10.write_int('tenge_enable', 0)
fpga10.write_int('adc_rst', 3)

fpga11.write_int('tenge_enable', 0)
fpga11.write_int('adc_rst', 3)

fpga12.write_int('tenge_enable', 0)
fpga12.write_int('adc_rst', 3)

fpga13.write_int('tenge_enable', 0)
fpga13.write_int('adc_rst', 3)

fpga14.write_int('tenge_enable', 0)
fpga14.write_int('adc_rst', 3)

fpga15.write_int('tenge_enable', 0)
fpga15.write_int('adc_rst', 3)

fpga16.write_int('tenge_enable', 0)
fpga16.write_int('adc_rst', 3)



fpga1.write_int('adc_rst', 0)
fpga2.write_int('adc_rst', 0)
fpga3.write_int('adc_rst', 0)
fpga4.write_int('adc_rst', 0)
fpga5.write_int('adc_rst', 0)
fpga6.write_int('adc_rst', 0)
fpga7.write_int('adc_rst', 0)
fpga8.write_int('adc_rst', 0)
fpga9.write_int('adc_rst', 0)
fpga10.write_int('adc_rst', 0)
fpga11.write_int('adc_rst', 0)
fpga12.write_int('adc_rst', 0)
fpga13.write_int('adc_rst', 0)
fpga14.write_int('adc_rst', 0)
fpga15.write_int('adc_rst', 0)
fpga16.write_int('adc_rst', 0)
