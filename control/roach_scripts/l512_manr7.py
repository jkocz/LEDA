...
dest_mac1 = 2*(2**32) + 201*(2**24) + 236*(2**16) + 155*(2**8) +  10 # 00:02:c9:ec:9b:10
dest_mac2 = 2*(2**32) + 201*(2**24) + 236*(2**16) + 154*(2**8) +  80 # 00:02:c9:ec:9a:80
...
dest_mac5 = 2*(2**32) + 201*(2**24) + 236*(2**16) + 156*(2**8) +  40 # 00:02:c9:ec:9c:40
