...
dest_mac1 = 2*(2**32) + 201*(2**24) + 12*(2**16) + 254*(2**8) + 141 #
dest_mac2 = 2*(2**32) + 201*(2**24) + 12*(2**16) + 255*(2**8) + 120 #
dest_mac3 = 2*(2**32) + 201*(2**24) + 12*(2**16) + 255*(2**8) + 84 #

dest_macff= 255*(2**32) + 255*(2**24) + 255*(2**16) + 255*(2**8) + 255
