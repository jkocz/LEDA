...
print('Connecting to server %s on port... '%(roach1)),
fpga = corr.katcp_wrapper.FpgaClient(roach1, 7147)
...
fpga.tap_start(gbe0,'tenge_gbe00',mac_base0+src_ip_base,src_ip_base,src_port0)
fpga.tap_start(gbe1,'tenge_gbe01',mac_base0+src_ip_base+1,src_ip_base+1,src_port1)
