...
dest_ip0   = 192*(2**24) + 168*(2**16) + 9*(2**8) + 4 #192.168.6.7
dest_ip1   = 192*(2**24) + 168*(2**16) + 7*(2**8) +  4 #192.168.6.7
dest_ip2   = 192*(2**24) + 168*(2**16) + 6*(2**8) + 4 #192.168.6.7
dest_ip3   = 192*(2**24) + 168*(2**16) + 10*(2**8) + 4 #192.168.6.7
dest_ip0   = 192*(2**24) + 168*(2**16) + 10*(2**8) + 4 #192.168.6.7
dest_ip1   = 192*(2**24) + 168*(2**16) + 10*(2**8) +  4 #192.168.6.7
dest_ip2   = 192*(2**24) + 168*(2**16) + 10*(2**8) + 4 #192.168.6.7
dest_ip3   = 192*(2**24) + 168*(2**16) + 10*(2**8) + 4 #192.168.6.7
dest_port0 = 4017
dest_port1 = 4016
dest_port2 = 4018
...
src_ip0    = 192*(2**24) + 168*(2**16) + 9*(2**8) + 50  #192.168.6.10
src_ip1    = 192*(2**24) + 168*(2**16) + 7*(2**8) + 51  #192.168.6.10
src_ip2    = 192*(2**24) + 168*(2**16) +6*(2**8) + 52  #192.168.6.10
src_ip3    = 192*(2**24) + 168*(2**16) + 10*(2**8) + 53  #192.168.6.10
src_ip0    = 192*(2**24) + 168*(2**16) + 10*(2**8) + 50  #192.168.6.10
src_ip1    = 192*(2**24) + 168*(2**16) + 10*(2**8) + 51  #192.168.6.10
src_ip2    = 192*(2**24) + 168*(2**16) +10*(2**8) + 52  #192.168.6.10
src_ip3    = 192*(2**24) + 168*(2**16) + 10*(2**8) + 53  #192.168.6.10
src_port0  = 4000
src_port1  = 4001
src_port2  = 4002
...
fpga.write_int('pkt_sim2_roach_num',2)
fpga.write_int('pkt_sim1_roach_num',1)
fpga.write_int('pkt_sim_roach_num',0)
fpga.write_int('pkt_sim3_roach_num',3)
